<template>
	<el-menu background-color="transparent" :collapse="state.isCollapse" :collapse-transition="false" :default-active="state.defaultActive"
		router :unique-opened="getThemeConfig.isUniqueOpened">
