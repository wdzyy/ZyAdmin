...
<template>
	<div class="upgrade-dialog">
		<el-dialog v-model="state.isUpgrade" :close-on-click-modal="false" :close-on-press-escape="false" destroy-on-close :show-close="false"
			width="300px">
			...
			<div class="upgrade-content">
				...
				<div class="mt-5px">
					<el-link class="text-12px" href="https://github.com/wdzyy/ZyAdmin" target="_black" type="primary">
						CHANGELOG.md
					</el-link>
				</div>
				<div class="upgrade-content-desc mt-5px">
					提示：更新会还原默认配置
				</div>
			</div>
			<div class="upgrade-btn">
				<el-button round size="default" text type="info" @click="onCancel">
					残忍拒绝
				</el-button>
				<el-button :loading="state.isLoading" round size="default" type="primary" @click="onUpgrade">
					{{ state.btnTxt
					}}
				</el-button>
			</div>
