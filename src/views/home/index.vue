      ...
      <el-col v-for="(v, k) in state.homeOne" :key="k" :class="{ 'home-media home-media-lg': k > 1, 'home-media-sm': k === 1 }" :lg="6" :md="12" :sm="12" :xl="6"
        ...
        <div class="home-card-item flex">
          <div class="flex-margin w100 flex" :class="` home-one-animation${k}`">
            <div class="flex-auto">
              <span class="text-30px">{{ v.num1 }}</span>
              <span class="ml-5px text-16px" :style="{ color: v.color1 }">{{ v.num2 }}%</span>
              <div class="mt-10px">
                {{ v.num3 }}
              </div>
            </div>
            <div class="home-card-item-icon flex" :style="{ background: `var(${v.color2})` }">
              <i class="flex-margin text-32px" :class="v.num4" :style="{ color: `var(${v.color3})` }" />
            </div>
          </div>
        </div>
      </el-col>
    </el-row>
    <el-row class="home-card-two mb-15px" :gutter="15">
      <el-col :lg="16" :md="14" :sm="14" :xl="16" :xs="24">
        <div class="home-card-item">
          <div ref="homeLineRef" style="height: 100%" />
        </div>
      </el-col>
      <el-col class="home-media" :lg="8" :md="10" :sm="10" :xl="8" :xs="24">
        <div class="home-card-item">
          <div ref="homePieRef" style="height: 100%" />
        </div>
      </el-col>
    </el-row>
    <el-row class="home-card-three" :gutter="15">
      <el-col :lg="8" :md="10" :sm="10" :xl="8" :xs="24">
        <div class="home-card-item">
              ...
              <div v-for="(v, k) in state.homeThree" :key="k" class="flex-warp-item">
                <div class="flex-warp-item-box" :class="`home-animation${k}`">
                  <div class="flex-margin">
                    ...
                    <span class="pl-5px">{{ v.label }}</span>
                    <div class="mt-10px">
                      {{ v.value }}
                    </div>
                  </div>
      ...
      <el-col class="home-media" :lg="16" :md="14" :sm="14" :xl="16" :xs="24">
        <div class="home-card-item">
