...
// 获取 pinia 中的路由
function getMenuData(routes: RouteItems) {
...
<template>
  <div class="system-menu-dialog-container">
    <el-dialog v-model="state.dialog.isShowDialog" :title="state.dialog.title" width="769px">
      <el-form ref="menuDialogFormRef" label-width="80px" :model="state.ruleForm" size="default">
        <el-row :gutter="35">
          <el-col class="mb-20px" :lg="24" :md="24" :sm="24" :xl="24" :xs="24">
            <el-form-item label="上级菜单">
              <el-cascader v-model="state.ruleForm.menuSuperior" class="w100"
                clearable :options="state.menuData" placeholder="请选择上级菜单"
          ...
          <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
            <el-form-item label="菜单名称">
              <el-input v-model="state.ruleForm.meta.title" clearable placeholder="格式：message.router.xxx" />
            </el-form-item>
          </el-col>
          <template v-if="state.ruleForm.menuType === 'menu'">
            <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
              <el-form-item label="路由名称">
                <el-input v-model="state.ruleForm.name" clearable placeholder="路由中的 name 值" />
              </el-form-item>
            </el-col>
            <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
              <el-form-item label="路由路径">
                <el-input v-model="state.ruleForm.path" clearable placeholder="路由中的 path 值" />
              </el-form-item>
            </el-col>
            <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
              <el-form-item label="重定向">
                <el-input v-model="state.ruleForm.redirect" clearable placeholder="请输入路由重定向" />
              </el-form-item>
            </el-col>
            <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
            ...
            <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
              <el-form-item label="组件路径">
                <el-input v-model="state.ruleForm.componentAlias" clearable placeholder="组件路径" />
              </el-form-item>
            </el-col>
            <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
              <el-form-item label="链接地址">
                <el-input v-model="state.ruleForm.meta.isLink" clearable :disabled="!state.ruleForm.isLink"
                  placeholder="外链/内嵌时链接地址（http:xxx.com）" />
              </el-form-item>
            </el-col>
            <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
              <el-form-item label="权限标识">
                <el-select v-model="state.ruleForm.meta.roles" class="w100" clearable multiple placeholder="取角色管理">
          ...
          <template v-if="state.ruleForm.menuType === 'btn'">
            <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
              <el-form-item label="权限标识">
                <el-input v-model="state.ruleForm.btnPower" clearable placeholder="请输入权限标识" />
              </el-form-item>
            </el-col>
          </template>
          <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
            <el-form-item label="菜单排序">
              <el-input-number v-model="state.ruleForm.menuSort" class="w100" controls-position="right"
                placeholder="请输入排序" />
            </el-form-item>
          </el-col>
          <template v-if="state.ruleForm.menuType === 'menu'">
