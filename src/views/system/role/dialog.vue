...
// 打开弹窗
function openDialog(type: string, row: RowRoleType) {
  if (type === 'edit') {
    state.ruleForm = row
...
<template>
  <div class="system-role-dialog-container">
    <el-dialog v-model="state.dialog.isShowDialog" :title="state.dialog.title" width="769px">
      <el-form ref="roleDialogFormRef" label-width="90px" :model="state.ruleForm" size="default">
        <el-row :gutter="35">
          ...
          <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
            <el-form-item label="角色标识">
              ...
              <el-input v-model="state.ruleForm.roleSign" clearable placeholder="请输入角色标识" />
            </el-form-item>
          </el-col>
          <el-col class="mb-20px" :lg="12" :md="12" :sm="12" :xl="12" :xs="24">
            <el-form-item label="排序">
              <el-input-number
                v-model="state.ruleForm.sort" class="w100" controls-position="right" :max="999"
          ...
          <el-col class="mb-20px" :lg="24" :md="24" :sm="24" :xl="24" :xs="24">
            <el-form-item label="角色描述">
              <el-input
                v-model="state.ruleForm.describe" maxlength="150" placeholder="请输入角色描述"
                type="textarea"
              />
            </el-form-item>
          </el-col>
          <el-col class="mb-20px" :lg="24" :md="24" :sm="24" :xl="24" :xs="24">
            <el-form-item label="菜单权限">
              <el-tree class="menu-data-tree" :data="state.menuData" :props="state.menuProps" show-checkbox />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
